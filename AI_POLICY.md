...
The swamp-nats project has strict rules for AI usage:
...
These rules apply only to outside contributions to swamp-nats. Maintainers
...
Please remember that swamp-nats is maintained by humans.
...
swamp-nats is written with plenty of AI assistance, and many maintainers
